-- Owlexa demo seed data
-- Run this script in MySQL Workbench after selecting the target database.
-- The script is idempotent for the demo rows because it uses fixed IDs and
-- ON DUPLICATE KEY UPDATE on tables with unique constraints.

START TRANSACTION;

-- Optional clean reset for demo database.
-- Uncomment only if you want to remove the existing demo rows before reseeding.
--
...
-- ============================================================
-- 2) Users
-- Password is kept as plain text "123456" for demo compatibility.
-- AuthService supports legacy plain-text login and upgrades it to bcrypt
...
-- ============================================================
-- 4) Memberships
-- Owner + demo staff/students are linked to the center so tenant
-- resolution works when X-Tenant-ID is not explicitly provided.
-- ============================================================
