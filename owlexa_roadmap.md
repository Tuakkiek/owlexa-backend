...
- Luôn hoàn thiện Backend API trước → test bằng Postman/Swagger → sau đó mới làm Frontend
...
- Test toàn bộ với Postman Collection, thêm Swagger UI (springdoc-openapi) ★ Test kỹ

**Tech:** Spring Boot | Spring Security | JWT | MySQL | GitHub | Swagger
...
**Tech:** Spring Boot | Cloudinary | Sepay Webhook | MySQL | Swagger
...
tôi không muốn bạn trực tiếp sửa code mà hướng dẫn tôi cách tư duy để giải quyết vấn đề và code mẫu để tôi code theo, đi từng bước 1, code đơn giản trước rồi mới nâng cao dần lên
---
